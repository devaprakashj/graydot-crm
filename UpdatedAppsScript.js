...
function addLead(data) {
  ...
  // --- ADDED EMAIL NOTIFICATION TO ADMINS ---
  const adminBody = "You have received a new project lead from the website.<br><br>" +
                    "<b>Client Name:</b> " + data.clientName + "<br>" +
                    "<b>Phone:</b> " + data.phone + "<br>" +
                    "<b>Requirement:</b><br><pre style='font-family: inherit; font-size: 14px; white-space: pre-wrap;'>" + data.requirement + "</pre><br>" +
                    "<b>Budget:</b> " + data.budget + "<br>" +
                    "<b>Timeline:</b> " + data.timeline;
                    
  sendEmail("graydotservices@gmail.com, devaprakashofficial@gmail.com", "🚀 New Project Lead from Website!", "New Website Lead", adminBody);
  // ------------------------------------------
